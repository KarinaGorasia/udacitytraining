...
odds_ratio <- exp(coef(logistic_model2))
...
# the odds of churning are 51% lower if you are an active member
...
#prob_fit <- logit2prob(coef(logistic_model2))
##bb <- data.frame(Logit = fff,
##                 Probability = prob_fit)
##ggplot(bb, aes(x = Logit, y = Probability)) +
##  geom_point(size = 2, alpha = .3) +
#  labs(x = "logit", y = "probability of success")


# ConfusionTableR::binary_visualiseR(train_labels = p.factor,
#                                    truth_labels = actual.factor,
#                                    class_label1 = "Not Churned", 
#                                    class_label2 = "Churned",
#                                    quadrant_col1 = "#28ACB4", 
#                                    quadrant_col2 = "#4397D2", 
#                                    custom_title = "Churned Confusion Matrix", 
#                                    text_col= "black")
